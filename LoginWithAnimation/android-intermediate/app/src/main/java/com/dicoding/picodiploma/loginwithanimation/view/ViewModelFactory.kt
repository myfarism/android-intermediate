...
import com.dicoding.picodiploma.loginwithanimation.view.maps.MapsViewModel // Pastikan MapsViewModel diimport
...
class ViewModelFactory(
    ...
    companion object {
        ...
        private fun createFactory(context: Context): ViewModelFactory {
            ...
            val storyRepository = StoryRepository.getInstance(apiService, userPreference)
